    ...
    <section>
      <div className=' flex flex-col  md:flex-row items-center'>
        ...
        <div className='flex-1'>
          ...
          <p className='mt-6 text-lg text-slate-800 text-center sm:text-start'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe fugit harum at molestias debitis possimus enim.
